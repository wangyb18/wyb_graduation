...
# 读取json文件内容,返回字典格式
with open('result-in-domain.json', 'r', encoding='utf8')as fp:
    result = json.load(fp)
...
data.to_excel('ECE_ID' + str(T_begin) + '_' + str(T_end) + '.xlsx')
##
# 画图
...
plot_acc_con_figure(confidence_array, accuracy_array, 'ID')
##
# # 第一次应将键值修整的整洁
# if T == 1.0:
...
##
a=[0.9999934434890747, 0.9190085530281067, 0.9999997615814209, 0.999966025352478, 1.0, 1.0, 0.9999994039535522, 0.9999998807907104]
temp=1
